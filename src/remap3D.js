...
import CTMLoader from "three/examples/js/loaders/ctm/CTMLoader"
import wa from './assets/mesh/wa.ctm'
import yg from './assets/mesh/yangan_c4d.fbx'

// var ctm = new CTMLoader
// ctm.load(wa, function (o) {
//   console.log(o)
// })
var FBXload = new FBXLoader()
var objList = []
FBXload.load(yg, function (object) {
  console.log(object, 'fbx记载成功')
...
export class remap3D {
  ...
  addGltfObj (_obj) {
    ...
    GLTFload.load(_obj.url, function (object) {
      ...
      // object.scene.children[0].scale.x = 2
      // object.scene.children[0].scale.y = 2
      // object.scene.children[0].scale.z = 2
      obj = object.scene
      // console.log(obj)
      _this.scene.add(obj)
    }, () => {
